<template>
  <div
    class="flex min-h-screen items-center justify-center bg-surface-soft p-4"
  >
    <div class="w-full max-w-2xl">
      ...
      <div class="mb-8 text-center">
        ...
        >
          <Icon name="cog" size="xl" class="text-on-primary" />
        </div>
        <h1 class="text-3xl font-bold text-ink">{{ t("setup.title") }}</h1>
          ...
          <template v-for="(step, index) in steps" :key="step.id">
            <div class="flex items-center">
              <div
                :class="[
                  ...
                  currentStep > index
                    ...
                    : currentStep === index
                      ? 'bg-primary-500 text-on-primary ring-4 ring-primary-100 '
              ...
              <span
                ...
                :class="currentStep >= index ? 'text-ink ' : 'text-muted-soft '"
              >
                {{ step.title }}
              </span>
            </div>
            <div
              ...
              :class="currentStep > index ? 'bg-primary-500' : 'bg-hairline '"
            ></div>
          </template>
        </div>
      </div>
      ...
      <!-- Step Content -->
      <div class="rounded-lg bg-canvas p-8 shadow-card">
        <!-- Step 1: Database -->
        <div v-if="currentStep === 0" class="space-y-6">
          ...
          <div
            class="flex items-center justify-between rounded-xl border border-hairline p-3"
          >
            <div>
            ...
            <div>
              ...
              <Select
                ...
                :options="[
                  ...
                  {
                    value: 'verify-ca',
                    label: t('setup.database.ssl.verifyCa'),
                  },
                  {
                    value: 'verify-full',
                    label: t('setup.database.ssl.verifyFull'),
                  },
                ]"
              />
            </div>
        ...
        <div v-if="currentStep === 3" class="space-y-6">
          ...
          <div class="space-y-4">
            ...
            <div class="rounded-xl bg-surface-soft p-4">
              ...
              <p class="text-ink">{{ formData.admin.email }}</p>
            </div>
          </div>
        </div>
        ...
        <div
          v-if="errorMessage"
          class="mt-6 rounded-xl border border-error/25 bg-error/15 p-4"
        >
          <div class="flex items-start gap-3">
            <Icon
              name="exclamationCircle"
              size="md"
              class="flex-shrink-0 text-error"
            />
        ...
        <div
          v-if="installSuccess"
          class="mt-6 rounded-xl border border-success/25 bg-success/15 p-4"
        >
          <div class="flex items-start gap-3">
            <svg
              v-if="!serviceReady"

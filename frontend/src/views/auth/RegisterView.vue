      ...
      <form v-else @submit.prevent="handleRegister" class="space-y-5">
        ...
        <div v-if="invitationCodeEnabled">
          ...
          <div class="relative">
            ...
            >
              <svg
                class="h-4 w-4 animate-spin text-muted-soft"
                fill="none"
                viewBox="0 0 24 24"
              >
                <circle
          ...
          <transition name="fade">
            <div
              ...
              class="mt-2 flex items-center gap-2 rounded-lg bg-success/15 px-3 py-2"
            >
          ...
          <div class="relative">
            ...
            >
              <Icon
                ...
                size="md"
                :class="
                  promoValidation.valid ? 'text-success' : 'text-muted-soft '
                "
              />
            </div>
            <input
        ...
        <button
          type="submit"
          :disabled="
            registrationActionDisabled || (turnstileEnabled && !turnstileToken)
          "

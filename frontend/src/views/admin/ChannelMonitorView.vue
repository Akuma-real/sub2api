...
const columns = computed<Column[]>(() => [
  {
    key: "name",
    label: t("admin.channelMonitor.columns.name"),
    sortable: false,
  },
  {
    key: "provider",
    label: t("admin.channelMonitor.columns.provider"),
    sortable: false,
  },
  {
    key: "primary_model",
  ...
  {
    key: "latency",
    label: t("admin.channelMonitor.columns.latency"),
    sortable: false,
  },
  {
    key: "enabled",
  ...
  {
    key: "actions",
    label: t("admin.channelMonitor.columns.actions"),
    sortable: false,
  },
]);
...
async function reload() {
  ...
  try {
    ...
    const res = await adminAPI.channelMonitor.list(params, {
      signal: ctrl.signal,
    });
    ...
    appStore.showError(
      extractApiErrorMessage(err, t("admin.channelMonitor.loadError")),
    );
  } finally {
...
async function handleRunNow(row: ChannelMonitor) {
  ...
  try {
    ...
    appStore.showError(
      extractApiErrorMessage(err, t("admin.channelMonitor.runFailed")),
    );
  } finally {

    ...
    <TablePageLayout>
      <template #filters>
            ...
            <template #after>
              ...
              <div class="relative" ref="autoRefreshDropdownRef">
                ...
                <div
                  ...
                  class="absolute right-0 z-50 mt-2 w-56 origin-top-right rounded-lg border border-hairline bg-canvas shadow-card"
                >
                  <div class="p-2">
                    <button
              ...
              <div class="relative" ref="accountToolsDropdownRef">
                ...
                <div
                  ...
                  class="absolute right-0 z-50 mt-2 w-[min(20rem,calc(100vw-2rem))] origin-top-right overflow-hidden rounded-lg border border-hairline bg-canvas shadow-card"
                >
                  <div class="max-h-[70vh] overflow-y-auto p-2">
                    <div class="px-2 py-2">
                      <div
                        class="text-xs font-semibold uppercase tracking-wide text-muted-soft"
                      >
                    ...
                    >
                      <span
                        class="account-tools-menu-icon bg-accent-teal/10 text-primary-700"
                      >
                    ...
                    >
                      <span
                        class="account-tools-menu-icon bg-success/15 text-success"
                      >
                    ...
                    >
                      <span
                        class="account-tools-menu-icon bg-primary-100 text-primary-600"
                      >
                    ...
                    >
                      <span
                        class="account-tools-menu-icon bg-accent-amber/15 text-warning"
                      >
                    ...
                    >
                      <span
                        class="account-tools-menu-icon bg-surface-soft text-body"
                      >
        ...
        <div
          ...
          class="mt-2 flex items-center justify-between rounded-lg border border-accent-amber/30 bg-accent-amber/15 px-3 py-2 text-sm text-warning"
        >
          ...
          >
            ...
            <template #cell-notes="{ value }">
              <span
                v-if="value"
                :title="value"
                class="block max-w-xs truncate text-sm text-body"
                >{{ value }}</span
              >
            ...
            <template #cell-schedulable="{ row }">
              <button
                ...
                class="relative inline-flex h-5 w-9 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                :class="[
                  row.schedulable
                    ? 'bg-primary-500 hover:bg-primary-600'
                    : 'bg-hairline hover:bg-surface-cream-strong ',
                ]"
                :title="
                  row.schedulable
              ...
              >
                <span
                  class="pointer-events-none inline-block h-4 w-4 transform rounded-full bg-canvas shadow ring-0 transition duration-200 ease-in-out"
              ...
              <div class="flex flex-col items-start gap-1">
                ...
                >
                  <span
                    ...
                    class="inline-flex items-center rounded-md bg-accent-amber/15 px-2 py-0.5 text-xs font-medium text-warning"
                  >
            ...
            <template #cell-actions="{ row }">
              <div class="flex items-center gap-1">
                ...
                <button
                  ...
                  class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-muted transition-colors hover:bg-surface-card hover:text-ink"
                >
                  <svg
                    class="h-4 w-4"
                    fill="none"
...
const BulkEditAccountModal = defineAsyncComponent(
  () => import("@/components/account/BulkEditAccountModal.vue"),
);
const SyncFromCrsModal = defineAsyncComponent(
  () => import("@/components/account/SyncFromCrsModal.vue"),
);
const TempUnschedStatusModal = defineAsyncComponent(
  () => import("@/components/account/TempUnschedStatusModal.vue"),
);
const ImportDataModal = defineAsyncComponent(
  () => import("@/components/admin/account/ImportDataModal.vue"),
);
const ReAuthAccountModal = defineAsyncComponent(
  () => import("@/components/admin/account/ReAuthAccountModal.vue"),
);
const AccountTestModal = defineAsyncComponent(
  () => import("@/components/admin/account/AccountTestModal.vue"),
);
const AccountStatsModal = defineAsyncComponent(
  () => import("@/components/admin/account/AccountStatsModal.vue"),
);
const ScheduledTestsPanel = defineAsyncComponent(
...
const ErrorPassthroughRulesModal = defineAsyncComponent(
  () => import("@/components/admin/ErrorPassthroughRulesModal.vue"),
);
const TLSFingerprintProfilesModal = defineAsyncComponent(
...
watch(loading, (isLoading, wasLoading) => {
  if (wasLoading && !isLoading && pendingTodayStatsRefresh.value) {
    ...
    refreshTodayStatsBatch().catch((error) => {
      console.error(
        "Failed to refresh account today stats after table load: ",
        error,
      );
    });
  }

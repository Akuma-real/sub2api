    ...
    <form id="plan-form" @submit.prevent="handleSavePlan" class="space-y-4">
          ...
          >
            <template #selected="{ option }">
              <span
                ...
                :class="platformTextClass(String(option.platform))"
                >{{ option.label }}</span
              >
              <span v-else>{{
                option?.label || t("payment.admin.selectGroup")
              }}</span>
            </template>
      ...
      >
        ...
        <div class="grid grid-cols-2 gap-2 text-xs">
          <div>
            <span class="text-muted">{{ t("payment.admin.dailyLimit") }}:</span>
          ...
          <div>
            <span class="text-muted"
              >{{ t("payment.admin.weeklyLimit") }}:</span
            >
            <span class="ml-1 font-medium text-body">{{
          ...
          <div>
            <span class="text-muted"
              >{{ t("payment.admin.monthlyLimit") }}:</span
            >
            <span class="ml-1 font-medium text-body">{{
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          ><input
            v-model.number="planForm.original_price"
            type="number"
            step="0.01"
            min="0"
            class="input"
      ...
      <div class="grid grid-cols-2 gap-4">
        <div>
          <label class="input-label"
            ...
            <span class="text-error">*</span></label
          ><input
            v-model.number="planForm.validity_days"
            type="number"
            min="1"
            class="input"
            required
      ...
      <div class="flex items-center gap-3">
        ...
        <button
          ...
          :class="[
            ...
            planForm.for_sale ? 'bg-primary-500' : 'bg-surface-cream-strong ',
          ]"

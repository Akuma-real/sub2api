          ...
          <div class="ml-auto flex flex-wrap items-center justify-end gap-3">
            ...
            <div class="relative" ref="columnDropdownRef">
              ...
              <div
                ...
                class="absolute right-0 z-50 mt-2 w-48 origin-top-right rounded-lg border border-hairline bg-canvas shadow-lg"
              >
                <div class="p-2">
        ...
        >
            ...
            <div class="min-w-[280px] space-y-2">
              ...
              <div v-if="row.group?.daily_limit_usd" class="usage-row">
                <div class="flex items-center gap-2">
                  ...
                  <div class="h-1.5 flex-1 rounded-full bg-hairline-soft">
                    <div
              ...
              <div
                ...
                "
                class="flex items-center gap-2 rounded-lg bg-success/15 px-3 py-2"
              >
          ...
          <template #cell-expires_at="{ value }">
            <div v-if="value">
              ...
              <div v-if="getDaysRemaining(value) !== null" class="text-xs text-muted">
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-muted transition-colors hover:bg-surface-soft hover:text-primary-600"
              >
        ...
        <div>
          ...
          >
            <template #selected="{ option }">
              ...
              />
              <span v-else class="text-muted-soft">{{ t('admin.subscriptions.selectGroup') }}</span>
            </template>
    ...
    >
      ...
      >
        <div class="rounded-lg bg-cream p-4">
          ...
          <p v-if="extendingSubscription.expires_at" class="mt-1 text-sm text-body">
    ...
    <teleport to="body">
      <transition name="modal">
        <div v-if="showGuideModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" @mousedown.self="showGuideModal = false">
          <div class="fixed inset-0 bg-ink/50" @click="showGuideModal = false"></div>
          <div class="relative max-h-[85vh] w-full max-w-2xl overflow-y-auto rounded-xl bg-canvas p-6 shadow-2xl">
            <button type="button" class="absolute right-4 top-4 text-muted-soft hover:text-body" @click="showGuideModal = false">
              <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" /></svg>
            </button>

            <h2 class="mb-4 text-lg font-bold text-ink">{{ t('admin.subscriptions.guide.title') }}</h2>
            ...
            <div class="mb-5">
              ...
              <div class="ml-8 overflow-hidden rounded-lg border border-hairline">
                <table class="w-full text-sm">
                  <tbody>
                    <tr v-for="(row, i) in guideActionRows" :key="i" class="border-b border-hairline-soft">
                      <td class="whitespace-nowrap bg-cream px-3 py-2 font-medium text-body">{{ row.action }}</td>
            ...
            <!-- Tip -->
            <div class="rounded-lg bg-surface-card p-3 text-xs text-body">
...
const getProgressClass = (used: number | null | undefined, limit: number | null): string => {
  if (!limit || limit === 0) return 'bg-hairline-soft'
  const usedValue = used ?? 0

  ...
  <AppLayout>
    <TablePageLayout>
      ...
      <template #pagination>
        <div
          ...
          class="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-lg border border-primary-100 bg-primary-50 p-3"
        >
    ...
    <Teleport to="body">
      ...
      >
        ...
        <div
          class="relative z-10 w-full max-w-lg rounded-xl bg-canvas p-6 shadow-xl"
        >

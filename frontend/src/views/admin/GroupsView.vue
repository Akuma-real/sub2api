      ...
      <template #table>
        ...
        >
          ...
          <template #cell-platform="{ value }">
            <span
              :class="[
                ...
                value === 'anthropic'
                  ? 'bg-accent-amber/15 text-primary-600'
                  : value === 'openai'
                    ? 'bg-success/15 text-success'
                    : value === 'antigravity'
                      ? 'bg-surface-card text-accent-amber'
                      : 'bg-surface-card text-primary-600',
              ]"
            >
          ...
          <template #cell-account_count="{ row }">
            <div class="space-y-0.5 text-xs">
              <div>
                ...
                >
                <span
                  class="ml-1 inline-flex items-center rounded bg-surface-card px-1.5 py-0.5 font-medium text-ink"
              ...
              <div v-if="row.rate_limited_account_count">
                ...
                <span
                  class="ml-1 font-medium text-accent-amber"
              ...
              <div>
                ...
                <span
                  class="ml-1 font-medium text-body"
          ...
          <template #cell-usage="{ row }">
            <div v-if="usageLoading" class="text-xs text-muted-soft">—</div>
            <div v-else class="space-y-0.5 text-xs">
              <div class="text-muted">
                <span class="text-muted-soft">{{
                  t("admin.groups.usageToday")
                }}</span>
                <span class="ml-1 font-medium text-body"
                  >${{
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-muted transition-colors hover:bg-surface-card hover:text-accent-amber"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-muted transition-colors hover:bg-surface-soft hover:text-error"
              >
      ...
      >
          ...
          <div class="mb-1.5 flex items-center gap-1">
            ...
            <div class="group relative inline-flex">
              <Icon
                ...
                size="sm"
                :stroke-width="2"
                class="cursor-help text-muted-soft transition-colors hover:text-primary-500"
              />
              <div
              ...
              >
                <div
                  class="rounded-lg bg-surface-dark p-3 text-on-dark shadow-lg"
                >
                  <p class="text-xs leading-relaxed text-muted-soft">
                    {{ t("admin.groups.copyAccounts.tooltip") }}
                  </p>
                  <div
                    class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-surface-dark"
                  ></div>
                </div>
              </div>
            </div>
            ...
            <div class="group relative inline-flex">
              ...
              >
                ...
                >
                  ...
                  <p class="mb-2 text-xs leading-relaxed text-muted-soft">
                    {{ t("admin.groups.exclusiveTooltip.description") }}
                  </p>
                  <div class="rounded bg-surface-dark-elevated p-2">
                    <p class="text-xs leading-relaxed text-muted-soft">
                      <span
        ...
        <div class="border-t pt-4">
          ...
          <div
            ...
            class="overflow-hidden rounded-lg border border-hairline bg-surface-card"
          >
            <div
              v-if="!createModelsListLoading && createModelsListState.items.length > 0"
              class="flex items-center justify-between gap-2 border-b border-hairline bg-surface-soft px-3 py-2 text-xs"
            >
              <span class="text-muted">
              ...
              <div class="flex items-center gap-1.5">
                ...
                <button
                  type="button"
                  class="rounded px-2 py-1 font-medium text-muted transition-colors hover:bg-canvas hover:text-ink"
            ...
            >
              ...
              <div
                ...
                :key="item.id"
                class="flex items-center gap-2 rounded border border-hairline bg-canvas px-3 py-2"
              >
                <input
                ...
                />
                <span class="min-w-0 flex-1 break-all text-sm text-body">
                  {{ item.id }}
                </span>
                <button
                  type="button"
                  :disabled="index === 0"
                  class="rounded p-1 text-muted-soft hover:bg-surface-soft hover:text-ink disabled:opacity-40"
        ...
        >
          <label
            class="block mb-2 font-medium text-body"
          >
          ...
          <div class="mt-2 rounded-lg bg-cream p-3 text-xs text-body">
        ...
        >
          ...
          <div class="flex items-center justify-between">
            ...
            >
              <span
                class="pointer-events-none inline-block h-5 w-5 transform rounded-full bg-canvas shadow ring-0 transition duration-200 ease-in-out"
                :class="
                  createForm.allow_messages_dispatch
                    ? 'translate-x-6'
                    : 'translate-x-1'
          ...
          <div v-if="createForm.allow_messages_dispatch" class="mt-3">
            <div
              class="relative overflow-hidden rounded-xl border border-hairline bg-canvas shadow-sm"
            >
              <div
                class="border-b border-hairline-soft bg-cream/80 px-4 py-3"
              >
            ...
            <div
              class="mt-5 relative overflow-hidden rounded-xl border border-primary-200 bg-canvas shadow-sm"
            >
              <div
              ...
              <div class="p-4 bg-cream/30">
                <div
                  v-if="createForm.exact_model_mappings.length === 0"
                  class="flex items-center justify-between gap-3 rounded-xl border-2 border-dashed border-primary-200 bg-canvas px-5 py-4 text-sm text-primary-700 transition-colors hover:border-primary-300"
                >
                  <span>{{
                ...
                <div v-else class="space-y-3">
                  <div
                    ...
                    class="group relative rounded-xl border border-hairline bg-canvas p-4 shadow-sm transition-all hover:border-primary-300 hover:shadow-md"
                  >
                    <div class="flex items-center gap-4">
                      ...
                      >
                        <div>
                          ...
                          <input
                            ...
                            "
                            class="input bg-cream focus:bg-canvas"
                          />
                        </div>
                        <div
                      ...
                      <button
                        ...
                        class="mt-6 flex h-9 w-9 items-center justify-center rounded-lg text-muted-soft transition-colors hover:bg-surface-soft hover:text-error"
                        :title="
                  ...
                  <button
                    type="button"
                    @click="addCreateMessagesDispatchMapping"
                    class="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-dashed border-hairline bg-canvas py-3 text-sm font-medium text-muted transition-all hover:border-primary-300 hover:bg-primary-50/50 hover:text-primary-600"
                  >
                    <Icon name="plus" size="sm" />
                    {{ t("admin.groups.openaiMessages.addExactMapping") }}
                  </button>
            ...
            >
              <div class="flex items-start gap-3">
                      ...
                      <div
                        v-if="
                          ...
                          accountSearchResults[getCreateRuleSearchKey(rule)]
                            ?.length > 0
                        "
                        class="absolute z-50 mt-1 max-h-48 w-full overflow-auto rounded-lg border bg-canvas shadow-lg"
                      >
                        <button
                          ...
                          class="w-full px-3 py-2 text-left text-sm hover:bg-surface-card"
                          :class="{
                ...
                <button
                  ...
                  class="mt-5 p-1.5 text-muted-soft hover:text-error transition-colors"
      ...
      <div class="space-y-4">
        ...
        >
          <div
            ...
            :key="group.id"
            class="flex cursor-grab items-center gap-3 rounded-lg border border-hairline bg-canvas p-3 transition-shadow hover:shadow-md active:cursor-grabbing"
          >
            ...
            <div class="text-sm text-muted-soft">#{{ group.id }}</div>
          </div>
        </VueDraggable>
      </div>

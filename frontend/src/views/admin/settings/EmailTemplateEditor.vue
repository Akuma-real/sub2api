<template>
  <div class="card">
    <div
      class="flex flex-col gap-3 border-b border-hairline-soft px-6 py-4 lg:flex-row lg:items-start lg:justify-between"
    >
      <div>
      ...
      <template v-else>
        ...
        >
          <div class="flex flex-wrap items-center gap-2">
            ...
            <span
              class="rounded-full bg-canvas px-2.5 py-1 text-xs font-medium text-body shadow-sm ring-1 ring-hairline"
            >
        ...
        <div
          ...
          class="rounded-lg border border-accent-amber/30 bg-accent-amber/10 p-4 text-sm text-warning"
        >
        ...
        <div v-else class="grid grid-cols-1 gap-6 xl:grid-cols-2">
            ...
            >
              ...
              <div class="mt-3 flex flex-wrap gap-2">
                <button
                  ...
                  :key="placeholder"
                  type="button"
                  class="rounded-full border border-hairline bg-canvas px-3 py-1 font-mono text-xs text-body transition-colors hover:border-primary-200 hover:text-primary-600"
          ...
          <div class="space-y-4">
            ...
            >
              <div
                class="flex items-center justify-between border-b border-hairline px-4 py-3"
              >
                <div>
                  <div class="text-sm font-medium text-ink">
                ...
                <span
                  ...
                  class="rounded-full bg-primary-500/10 px-2.5 py-1 text-xs font-medium text-primary-700"
                >
              ...
              <div class="bg-surface-soft p-3">
                <iframe
                  class="h-[36rem] w-full rounded-md border border-hairline bg-canvas"
                  sandbox=""
                  :srcdoc="previewHtml"

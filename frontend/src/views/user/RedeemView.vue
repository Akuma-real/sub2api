  ...
  <AppLayout>
    <div class="mx-auto max-w-2xl space-y-6">
      ...
      <div class="card overflow-hidden">
        <div
          class="bg-primary-500 px-6 py-8 text-center"
        >
          <div
            class="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-lg bg-canvas/20 "
          >
            <Icon name="creditCard" size="xl" class="text-on-primary" />
          </div>
          <p class="text-sm font-medium text-primary-100">
            {{ t("redeem.currentBalance") }}
          </p>
          <p class="mt-2 text-4xl font-bold text-on-primary">
          ...
          <form @submit.prevent="handleRedeem" class="space-y-5">
            <div>
              ...
              <div class="relative mt-1">
                ...
                >
                  <Icon name="gift" size="md" class="text-muted-soft" />
                </div>
                <input
                  id="code"
                  v-model="redeemCode"
      ...
      <transition name="fade">
        <div v-if="redeemResult" class="card border-success/25 bg-success/15">
          <div class="p-6">
            <div class="flex items-start gap-4">
              <div
                class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-success/15"
              >
                  ...
                  <div class="mt-3 space-y-1">
                    ...
                    >
                      ...
                      <span v-if="redeemResult.validity_days">
                        ({{
                          t("redeem.subscriptionDays", {
                            days: redeemResult.validity_days,
                          })
                        }})</span
                      >
                    </p>
      ...
      <!-- Error Message -->
      <transition name="fade">
        <div v-if="errorMessage" class="card border-error/25 bg-error/15">
          <div class="p-6">
            <div class="flex items-start gap-4">
              <div
                class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-error/15"
              >
                <Icon name="exclamationCircle" size="md" class="text-error" />
              </div>
              <div class="flex-1">
        ...
        <div class="p-6">
          ...
          <div v-else-if="history.length > 0" class="space-y-3">
            <div
              ...
              :key="item.id"
              class="flex items-center justify-between rounded-xl bg-surface-soft p-4"
            >
              <div class="flex items-center gap-4">
                ...
                >
                  ...
                  <Icon
                    ...
                    size="md"
                    :class="
                      item.value >= 0 ? 'text-primary-700 ' : 'text-warning '
                    "
                  />
                </div>
                <div>
              ...
              <div class="text-right">
                ...
                <p
                  ...
                  class="font-mono text-xs text-muted-soft"
                >
                  {{ item.code.slice(0, 8) }}...
                </p>
          ...
          <div v-else class="empty-state py-8">
            <div
              class="mb-4 flex h-16 w-16 items-center justify-center rounded-lg bg-surface-card"
            >
              <Icon name="clock" size="xl" class="text-muted-soft" />
            </div>
...
const getHistoryItemTitle = (item: RedeemHistoryItem) => {
  if (item.type === "balance") {
    ...
    return item.value >= 0
      ? t("redeem.balanceAddedAdmin")
      : t("redeem.balanceDeductedAdmin");

  ...
  <AppLayout>
    <div class="mx-auto max-w-4xl space-y-6">
      ...
      <template v-else>
        ...
        <div
          ...
          class="flex space-x-1 rounded-xl bg-surface-card p-1"
        >
          <button
            v-for="tab in tabs"
            :key="tab.key"
        ...
        <template v-else>
          ...
          <template v-if="activeTab === 'recharge'">
            ...
            <div class="card p-5">
              <p class="text-xs font-medium text-muted-soft">
                {{ t("payment.rechargeAccount") }}
              </p>
              <p class="mt-1 text-base font-semibold text-ink">
                {{ user?.username || "" }}
              </p>
              <p class="mt-0.5 text-sm font-medium text-success">
            ...
            <template v-else>
              <div class="card p-6">
                <AmountInput
                  ...
                  :max="globalMaxAmount"
                />
                <p v-if="amountError" class="mt-2 text-xs text-warning">
                  {{ amountError }}
                </p>
              </div>
              ...
              <div v-if="validAmount > 0" class="card p-6">
                <div class="space-y-2 text-sm">
                  ...
                  <div
                    v-if="feeRate > 0"
                    class="flex justify-between border-t border-hairline pt-2"
                  >
                  ...
                  <div
                    ...
                    :class="{ 'border-t border-hairline pt-2 ': feeRate <= 0 }"
                  >
                    <span class="text-muted">{{
                  ...
                  <p
                    v-if="balanceRechargeMultiplier !== 1"
                    class="border-t border-hairline pt-2 text-xs text-muted"
                  >
                    {{
          ...
          <template v-else-if="activeTab === 'subscription'">
            ...
            <template v-if="selectedPlan">
              <div class="card p-8">
                <div class="flex flex-wrap items-start justify-between gap-6">
                  <div class="min-w-0 flex-1">
                    ...
                    <p
                      ...
                      class="mt-3 max-w-2xl text-sm leading-relaxed text-muted"
                    >
                  ...
                  <div class="shrink-0 text-right">
                    <div class="flex flex-wrap items-baseline justify-end gap-x-2 gap-y-1">
                      ...
                      <span
                        class="font-display text-4xl font-medium leading-none text-ink"
                      >
                    ...
                    <p
                      v-if="
                        selectedPlan.original_price &&
                        selectedPlan.original_price > selectedPlan.price
                      "
                ...
                <div class="mt-6 rounded-lg border border-hairline bg-surface-card p-4">
                  <div class="grid gap-3 sm:grid-cols-2">
                    ...
                    <div v-if="selectedPlan.daily_limit_usd != null" class="flex items-center justify-between">
                      <span class="text-xs text-muted-soft">{{
                    ...
                    <div v-if="selectedPlan.weekly_limit_usd != null" class="flex items-center justify-between">
                      <span class="text-xs text-muted-soft">{{
                    ...
                    <div v-if="selectedPlan.monthly_limit_usd != null" class="flex items-center justify-between">
                      <span class="text-xs text-muted-soft">{{
              ...
              >
                ...
                <span v-else
                  ...
                  {{
                    formatSelectedPaymentAmount(
                      feeRate > 0 ? subTotalAmount : selectedPlan.price,
                    )
                  }}</span
                >
              </button>
            ...
            <template v-else>
              ...
              >
                <Icon
                  name="gift"
                  size="xl"
                  class="mx-auto mb-3 text-muted-soft"
                />
              ...
              <div v-if="activeSubscriptions.length > 0">
                <p class="mb-2 text-xs font-medium text-muted-soft">
                ...
                <div class="space-y-2">
                  <div
                    ...
                    :key="sub.id"
                    class="flex items-center gap-3 rounded-xl border border-hairline-soft bg-canvas px-3 py-2"
                  >
                    <div
                      :class="[
                    ...
                    <div class="min-w-0 flex-1">
                      ...
                      <div
                        class="flex flex-wrap gap-x-3 text-[11px] text-muted-soft"
                      >
                        <span
                          >{{ t("payment.planCard.rate") }}: ×{{
    ...
    <Teleport to="body">
      <Transition name="modal">
        ...
        >
          <div
            class="relative w-full max-w-lg rounded-lg border border-hairline bg-canvas p-6 shadow-card"
          >
            <!-- Close button -->
            <button
              class="absolute right-4 top-4 rounded-lg p-1 text-muted-soft transition-colors hover:bg-surface-card hover:text-body"
    ...
    <Teleport to="body">
      <Transition name="modal">
        <div
          v-if="previewImage"
          class="fixed inset-0 z-[60] flex items-center justify-center bg-ink/70 "
          @click="previewImage = ''"
        >
          <img
            :src="previewImage"
            alt=""
            class="max-h-[85vh] max-w-[90vw] rounded-xl object-contain shadow-card"
          />
        </div>
      </Transition>
    </Teleport>
...
// Payment button stays on the shared coral primary CTA style.

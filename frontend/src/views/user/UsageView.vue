          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-accent-teal/15 p-2">
                <Icon name="document" size="md" class="text-primary-700" />
              </div>
              <div>
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-accent-amber/15 p-2">
                <Icon name="cube" size="md" class="text-warning" />
              </div>
              <div>
                <p class="text-xs font-medium text-muted">
                  {{ t("usage.totalTokens") }}
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-primary-100 p-2">
                <Icon name="clock" size="md" class="text-primary-700" />
              </div>
              <div>
                <p class="text-xs font-medium text-muted">
                  {{ t("usage.avgDuration") }}
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-endpoint="{ row }">
            <span
              class="text-sm text-body block max-w-[320px] whitespace-normal break-all"
            >
          ...
          <template #cell-tokens="{ row }">
            <!-- 图片生成请求（仅按次计费时显示图片格式） -->
            <div
              v-if="row.image_count > 0 && row.billing_mode === 'image'"
            ...
            <div v-else class="flex items-center gap-1.5">
              <div class="space-y-1.5 text-sm">
                ...
                <div class="flex items-center gap-2">
                  ...
                  <!-- Output -->
                  <div class="inline-flex items-center gap-1">
                    <Icon name="arrowUp" size="sm" class="text-primary-600" />
                    <span class="font-medium text-ink">{{
          ...
          <div class="mb-2 border-b border-surface-dark-elevated pb-1.5">
            ...
            <template
              v-if="
                ...
                tooltipData.billing_mode === 'token'
              "
            >
              <div

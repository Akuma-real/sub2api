      ...
      <template v-else-if="detail">
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div class="card p-5">
            ...
            <p class="mt-2 text-2xl font-semibold text-primary-600">
              {{ formattedRebateRate
              }}<span class="ml-0.5 text-base font-medium">%</span>
            </p>
        ...
        <div class="card p-6">
          ...
          <div class="mt-5 grid gap-4 md:grid-cols-2">
            <div class="space-y-2">
              ...
              <div
                class="flex items-center gap-2 rounded-xl border border-hairline bg-surface-soft px-3 py-2"
              >
                <code class="flex-1 truncate text-sm font-semibold text-ink">{{
                  detail.aff_code
                }}</code>
            ...
            <div class="space-y-2">
              ...
              <div
                class="flex items-center gap-2 rounded-xl border border-hairline bg-surface-soft px-3 py-2"
              >
                <code class="flex-1 truncate text-sm text-body">{{
                  inviteLink
                }}</code>
                <button
          ...
          <div
            class="mt-5 rounded-xl border border-primary-200 bg-primary-50 p-4"
          >
            ...
            <ul class="mt-2 space-y-1 text-sm text-primary-700">
              ...
              <li>
                2.
                {{
                  t("affiliate.tips.line2", { rate: `${formattedRebateRate}%` })
                }}
              </li>
              <li>3. {{ t("affiliate.tips.line3") }}</li>
              <li v-if="detail.aff_frozen_quota > 0">
                4. {{ t("affiliate.tips.line4") }}
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="card p-6">
          ...
          >
            ...
            >
              ...
              <span>{{
                transferring
                  ? t("affiliate.transfer.transferring")
        ...
        <div class="card p-6">
          ...
          <div
            ...
            class="mt-4 rounded-xl border border-dashed border-hairline p-6 text-center text-sm text-muted"
          >
          ...
          <div v-else class="mt-4 overflow-x-auto">
            <table class="w-full min-w-[560px] text-left text-sm">
              ...
              <tbody>
                ...
                >
                  <td class="px-3 py-3 text-ink">{{ item.email || "-" }}</td>
...
async function loadAffiliateDetail(silent = false): Promise<void> {
  ...
  try {
    ...
    appStore.showError(
      extractApiErrorMessage(error, t("affiliate.loadFailed")),
    );
  } finally {
    if (!silent) {
      loading.value = false;

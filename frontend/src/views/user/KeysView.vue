  ...
  <AppLayout>
        ...
        >
          <template #cell-key="{ value, row }">
            <div class="flex items-center gap-2">
              ...
              <button
                ...
                class="rounded-lg p-1 transition-colors hover:bg-surface-card"
                :class="
                  copiedKeyId === row.id
                    ? 'text-success'
          ...
          <template #cell-group="{ row }">
            <div class="group/dropdown relative">
              <button
                ...
                class="-mx-2 -my-1 flex cursor-pointer items-center gap-2 rounded-lg px-2 py-1 transition-all duration-200 hover:bg-surface-card"
              ...
              >
                ...
                />
                <span v-else class="text-sm text-muted-soft">{{
                  t("keys.noGroup")
                }}</span>
                ...
                <svg
                  class="h-3.5 w-3.5 text-muted-soft opacity-60 transition-opacity group-hover/dropdown:opacity-100"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  stroke-width="2"
          ...
          <template #cell-usage="{ row }">
            <div class="text-sm">
              ...
              <div v-if="row.quota > 0" class="mt-1.5">
                ...
                <div
                  class="mt-1 h-1.5 w-full overflow-hidden rounded-full bg-hairline"
                >
                  <div
                    :class="[
          ...
          <template #cell-rate_limit="{ row }">
            ...
            >
              ...
              <div v-if="row.rate_limit_5h > 0">
                ...
                <div
                  class="h-1 w-full overflow-hidden rounded-full bg-hairline"
                >
                  <div
                    :class="[
                      'h-full rounded-full transition-all',
                ...
                <div
                  ...
                  class="text-[10px] text-muted-soft tabular-nums"
                >
              ...
              <button
                ...
                class="mt-0.5 inline-flex items-center gap-1 rounded px-1.5 py-0.5 text-xs text-muted transition-colors hover:bg-surface-card hover:text-primary-600"
          ...
          <template #cell-expires_at="{ value }">
            <span
              ...
              :class="[
                'text-sm',
                new Date(value) < new Date() ? 'text-error ' : 'text-muted ',
              ]"
            >
            ...
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                :class="[
                  ...
                  row.status === 'active'
                    ? 'text-muted hover:bg-accent-amber/15 hover:text-warning '
                    : 'text-muted hover:bg-success/15 hover:text-success ',
                ]"
              >
        ...
        <div v-if="!showEditModal" class="space-y-3">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                ...
                formData.use_custom_key ? 'bg-primary-600' : 'bg-hairline ',
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="formData.use_custom_key">
            <input
              ...
              :class="{ 'border-error ': customKeyError }"
            />
            <p v-if="customKeyError" class="mt-1 text-sm text-error">
              {{ customKeyError }}
            </p>
        ...
        <div class="space-y-3">
          ...
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-5 w-9 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none',
                formData.enable_quota ? 'bg-primary-600' : 'bg-hairline '
              ]"
            >
              <span
                :class="[
          ...
          <div class="space-y-4">
            ...
            <div v-if="showEditModal && selectedKey && selectedKey.quota > 0">
              ...
              <div class="flex items-center gap-2">
                <div class="flex-1 rounded-lg bg-surface-card px-3 py-2">
                  <span class="font-medium text-ink">
        ...
        <div class="space-y-3">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-5 w-9 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none',
                formData.enable_rate_limit ? 'bg-primary-600' : 'bg-hairline ',
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="formData.enable_rate_limit" class="space-y-4 pt-2">
            ...
            <div>
              ...
              >
                <div class="flex items-center gap-2">
                  <div
                    class="flex-1 rounded-lg bg-surface-card px-3 py-2 text-sm"
                  >
                    <span
                      :class="[
                        'font-medium',
        ...
        <div class="space-y-3">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-5 w-9 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none',
                formData.enable_expiration ? 'bg-primary-600' : 'bg-hairline ',
              ]"
            >
              <span
                :class="[
      ...
      <div class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-3">
          <button
            ...
            class="flex flex-col items-center gap-2 p-4 rounded-xl border-2 border-hairline hover:border-primary-500 hover:bg-primary-50 transition-all"
          >
            <Icon name="terminal" size="xl" class="text-body" />
            <span class="font-medium text-ink">{{
          ...
          <button
            ...
            class="flex flex-col items-center gap-2 p-4 rounded-xl border-2 border-hairline hover:border-primary-500 hover:bg-primary-50 transition-all"
          >
            <Icon name="sparkles" size="xl" class="text-body" />
            <span class="font-medium text-ink">{{
    ...
    <Teleport to="body">
      <div
        ...
        ref="dropdownRef"
        class="animate-in fade-in slide-in-from-top-2 fixed z-[100000020] w-max min-w-[380px] overflow-hidden rounded-xl bg-canvas shadow-card ring-1 ring-ink/5 duration-200"
      ...
      >
        <!-- Search box -->
        <div class="border-b border-hairline-soft p-2">
          <div class="relative">
            <svg
              class="absolute left-2.5 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-soft"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
              stroke-width="2"
            ...
            <input
              ...
              type="text"
              class="w-full rounded-lg border border-hairline bg-surface-soft py-1.5 pl-8 pr-3 text-sm text-ink placeholder-muted-soft outline-none focus:border-primary-300 focus:ring-1 focus:ring-primary-300"
        ...
        <div class="max-h-80 overflow-y-auto p-1.5">
          ...
          <div
            ...
            class="py-4 text-center text-sm text-muted-soft"
          >
            {{ t("keys.noGroupFound") }}
          </div>
        </div>

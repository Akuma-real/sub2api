...
describe('admin settings payment visible method helpers', () => {
  it('normalizes aliases into canonical source keys per visible method', () => {
    ...
    expect(normalizePaymentVisibleMethodSource('alipay', 'muyin')).toBe('muyin_alipay')
    ...
    expect(normalizePaymentVisibleMethodSource('wxpay', 'muyin')).toBe('muyin_wxpay')
  })

...
const openaiPresetMappings = [
  { label: 'GPT-4o', from: 'gpt-4o', to: 'gpt-4o', color: 'bg-accent-teal/15 text-accent-teal hover:bg-surface-cream-strong' },
  { label: 'GPT-4o Mini', from: 'gpt-4o-mini', to: 'gpt-4o-mini', color: 'bg-surface-card text-primary-600 hover:bg-surface-cream-strong' },
  { label: 'GPT-4.1', from: 'gpt-4.1', to: 'gpt-4.1', color: 'bg-surface-card text-primary-600 hover:bg-surface-cream-strong' },
  { label: 'o1', from: 'o1', to: 'o1', color: 'bg-surface-card text-accent-amber hover:bg-surface-cream-strong' },
  { label: 'o3', from: 'o3', to: 'o3', color: 'bg-accent-teal/15 text-accent-teal hover:bg-surface-cream-strong' },
  { label: 'GPT-5.3 Codex Spark', from: 'gpt-5.3-codex-spark', to: 'gpt-5.3-codex-spark', color: 'bg-accent-teal/15 text-accent-teal hover:bg-surface-cream-strong' },
  { label: 'GPT-5.2', from: 'gpt-5.2', to: 'gpt-5.2', color: 'bg-error/15 text-error hover:bg-surface-cream-strong' },
  { label: 'GPT-5.5', from: 'gpt-5.5', to: 'gpt-5.5', color: 'bg-surface-card text-accent-amber hover:bg-surface-cream-strong' },
  { label: 'GPT-5.4', from: 'gpt-5.4', to: 'gpt-5.4', color: 'bg-error/15 text-error hover:bg-surface-cream-strong' },
  { label: 'Haiku→5.4', from: 'claude-haiku-4-5-20251001', to: 'gpt-5.4', color: 'bg-accent-teal/15 text-accent-teal hover:bg-surface-cream-strong' },
  { label: 'Opus→5.4', from: 'claude-opus-4-6', to: 'gpt-5.4', color: 'bg-surface-card text-accent-amber hover:bg-surface-cream-strong' },
  { label: 'Sonnet→5.4', from: 'claude-sonnet-4-6', to: 'gpt-5.4', color: 'bg-surface-card text-primary-600 hover:bg-surface-cream-strong' }
]

const geminiPresetMappings = [
  { label: 'Flash 2.0', from: 'gemini-2.0-flash', to: 'gemini-2.0-flash', color: 'bg-surface-card text-primary-600 hover:bg-surface-cream-strong' },
  { label: '2.5 Flash', from: 'gemini-2.5-flash', to: 'gemini-2.5-flash', color: 'bg-surface-card text-primary-600 hover:bg-surface-cream-strong' },
  { label: '2.5 Image', from: 'gemini-2.5-flash-image', to: 'gemini-2.5-flash-image', color: 'bg-accent-teal/15 text-accent-teal hover:bg-surface-cream-strong' },
  { label: '2.5 Pro', from: 'gemini-2.5-pro', to: 'gemini-2.5-pro', color: 'bg-surface-card text-accent-amber hover:bg-surface-cream-strong' },
  { label: '3.5 Flash', from: 'gemini-3.5-flash', to: 'gemini-3.5-flash', color: 'bg-surface-card text-primary-600 hover:bg-surface-cream-strong' },
  { label: '3.1 Image', from: 'gemini-3.1-flash-image', to: 'gemini-3.1-flash-image', color: 'bg-accent-teal/15 text-accent-teal hover:bg-surface-cream-strong' }
]
...
const antigravityPresetMappings = [
  ...
  { label: 'Sonnet4→4.6', from: 'claude-sonnet-4-20250514', to: 'claude-sonnet-4-6', color: 'bg-surface-card text-primary-600 hover:bg-surface-cream-strong' },
  { label: 'Sonnet4.5→4.6', from: 'claude-sonnet-4-5-20250929', to: 'claude-sonnet-4-6', color: 'bg-surface-card text-primary-600 hover:bg-surface-cream-strong' },
  { label: 'Sonnet3.5→4.6', from: 'claude-3-5-sonnet-20241022', to: 'claude-sonnet-4-6', color: 'bg-accent-teal/15 text-accent-teal hover:bg-surface-cream-strong' },
  { label: 'Opus4.5→4.6', from: 'claude-opus-4-5-20251101', to: 'claude-opus-4-6-thinking', color: 'bg-surface-card text-accent-amber hover:bg-surface-cream-strong' },
  // Gemini 3→3.1 映射
  { label: '3-Pro-Preview→3.1-Pro-High', from: 'gemini-3-pro-preview', to: 'gemini-3.1-pro-high', color: 'bg-surface-card text-accent-amber hover:bg-surface-cream-strong' },
  { label: '3-Pro-High→3.1-Pro-High', from: 'gemini-3-pro-high', to: 'gemini-3.1-pro-high', color: 'bg-surface-card text-accent-amber hover:bg-surface-cream-strong' },
  { label: '3-Pro-Low→3.1-Pro-Low', from: 'gemini-3-pro-low', to: 'gemini-3.1-pro-low', color: 'bg-surface-card text-warning hover:bg-surface-cream-strong' },
  { label: '3.1-Pro-High透传', from: 'gemini-3.1-pro-high', to: 'gemini-3.1-pro-high', color: 'bg-surface-card text-accent-amber hover:bg-surface-cream-strong' },
  { label: '3.1-Pro-Low透传', from: 'gemini-3.1-pro-low', to: 'gemini-3.1-pro-low', color: 'bg-surface-card text-warning hover:bg-surface-cream-strong' },
  // Gemini 通配符映射
  { label: 'Gemini 3→Flash', from: 'gemini-3*', to: 'gemini-3-flash', color: 'bg-surface-card text-warning hover:bg-surface-cream-strong' },
  { label: 'Gemini 2.5→Flash', from: 'gemini-2.5*', to: 'gemini-2.5-flash', color: 'bg-surface-card text-accent-amber hover:bg-surface-cream-strong' },
  { label: '2.5-Flash-Image透传', from: 'gemini-2.5-flash-image', to: 'gemini-2.5-flash-image', color: 'bg-accent-teal/15 text-accent-teal hover:bg-surface-cream-strong' },
  { label: '3.1-Flash-Image透传', from: 'gemini-3.1-flash-image', to: 'gemini-3.1-flash-image', color: 'bg-accent-teal/15 text-accent-teal hover:bg-surface-cream-strong' },
  { label: '3-Pro-Image→3.1', from: 'gemini-3-pro-image', to: 'gemini-3.1-flash-image', color: 'bg-accent-teal/15 text-accent-teal hover:bg-surface-cream-strong' },
  { label: '3-Flash透传', from: 'gemini-3-flash', to: 'gemini-3-flash', color: 'bg-accent-teal/15 text-accent-teal hover:bg-surface-cream-strong' },
  { label: '2.5-Flash-Lite透传', from: 'gemini-2.5-flash-lite', to: 'gemini-2.5-flash-lite', color: 'bg-accent-teal/15 text-accent-teal hover:bg-surface-cream-strong' },
  // 精确映射
  { label: 'Sonnet 4.6', from: 'claude-sonnet-4-6', to: 'claude-sonnet-4-6', color: 'bg-surface-card text-primary-600 hover:bg-surface-cream-strong' },
...
const bedrockPresetMappings = [
  ...
  { label: 'Haiku 4.5', from: 'claude-haiku-4-5', to: 'us.anthropic.claude-haiku-4-5-20251001-v1:0', color: 'bg-success/15 text-success hover:bg-success/20' },
]

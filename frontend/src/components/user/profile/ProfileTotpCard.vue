<template>
  <div class="card">
    ...
    <div class="px-6 py-6">
      ...
      >
        <div class="flex-shrink-0 rounded-full bg-surface-card p-3">
          <svg
            class="h-6 w-6 text-muted-soft"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            stroke-width="1.5"
      ...
      >
        <div class="flex items-center gap-4">
          <div class="flex-shrink-0 rounded-full bg-success/15 p-3">
            <svg
          ...
          <div>
            ...
            <p v-if="status.enabled_at" class="text-sm text-muted">

  ...
  <div class="fixed inset-0 z-50 overflow-y-auto" @click.self="$emit('close')">
    <div class="flex min-h-full items-center justify-center p-4">
      ...
      >
        ...
        <div class="mb-6">
          <div
            class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-error/15"
          >
            <svg
          ...
          <h3 class="mt-4 text-center text-xl font-semibold text-ink">
...
const handleDisable = async () => {
  ...
  try {
    ...
    appStore.showError(
      err.response?.data?.message || t("profile.totp.disableFailed"),
    );
  } finally {
    loading.value = false;
  }

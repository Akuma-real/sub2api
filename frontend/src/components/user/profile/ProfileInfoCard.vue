    ...
    >
      <div class="px-8 py-8">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-start">
          <div
            class="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-primary-500 text-2xl font-bold text-on-primary shadow-sm"
          >
            <img
              v-if="avatarUrl"
              :src="avatarUrl"
          ...
          <div class="min-w-0 flex-1 space-y-5">
            <div class="space-y-3">
              <div class="flex flex-wrap items-center gap-2">
                <h2 class="truncate text-[22px] leading-tight text-ink">
                  {{ displayName }}
                </h2>
              ...
              <div class="space-y-1">
                ...
                >
                  <span
                    ...
                    :key="hint.key"
                    class="inline-flex items-center gap-1 rounded-full border border-hairline bg-canvas px-3 py-1 text-body"
                  >
            ...
            <div class="grid gap-3 sm:grid-cols-3">
              <div
                ...
                class="rounded-lg border border-hairline bg-surface-card px-4 py-3"
              >
                <p class="text-xs font-medium uppercase tracking-[0.16em] text-muted">
                  {{ t('profile.accountBalance') }}
                </p>
                <p class="mt-1 text-lg font-medium text-ink">
        ...
        >
          ...
          <div class="mt-5 grid gap-3">
            <div
              v-for="hint in sourceHints"
              :key="hint.key"
              class="flex items-start gap-3 rounded-lg border border-hairline bg-canvas px-4 py-3 text-sm text-body"
            >

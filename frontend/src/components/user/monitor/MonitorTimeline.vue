<template>
  <div class="mt-4 pt-3 border-t border-hairline-soft">
    <div
      class="flex justify-between text-[10px] font-semibold uppercase tracking-widest text-muted-soft mb-2"
    >
    ...
    <div
      v-if="maintenance"
      class="flex h-5 w-full items-center justify-center rounded border border-dashed border-hairline text-[10px] uppercase tracking-widest text-muted-soft"
    >
    ...
    <div
      class="mt-1 flex justify-between text-[9px] uppercase tracking-widest text-muted-soft"
    >
...
const { t } = useI18n();
const { statusLabel, formatLatency, formatRelativeTime } =

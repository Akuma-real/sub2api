<template>
  <div class="space-y-4">
    ...
    >
      <span
        class="mr-2 inline-flex h-5 w-5 items-center justify-center rounded-full bg-success/15 text-xs font-semibold text-success"
      >
        W
      </span>
...
const resolvedStart = computed(() =>
  resolveWeChatOAuthStart(appStore.cachedPublicSettings),
);
const buttonDisabled = computed(
  () => props.disabled || resolvedStart.value.mode === null,
);

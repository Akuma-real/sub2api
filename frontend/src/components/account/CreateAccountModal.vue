  ...
  >
    ...
    <div v-if="isOAuthFlow" class="mb-6 flex items-center justify-center">
      <div class="flex items-center space-x-4">
        ...
        <div class="h-0.5 w-8 bg-surface-cream-strong" />
        <div class="flex items-center">
          <div
            :class="[
              'flex h-8 w-8 items-center justify-center rounded-full text-sm font-semibold',
    ...
    >
      ...
      <div>
        ...
        <div
          class="mt-2 flex rounded-lg bg-surface-card p-1"
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'anthropic'
                ? 'bg-canvas text-warning shadow-sm '
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'openai'
                ? 'bg-canvas text-success shadow-sm '
                : 'text-body hover:text-ink ',
            ]"
          >
            <svg
      ...
      <div v-if="form.platform === 'anthropic'">
        ...
        <div
          class="mt-2 grid grid-cols-2 gap-3 sm:grid-cols-4"
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-hairline hover:border-accent-amber/30 ',
            ]"
          >
            <div
              :class="[
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'service_account'
                ...
                : 'border-hairline hover:border-accent-teal/30 ',
            ]"
          >
            <div
              :class="[
        ...
        <div
          ...
          class="mt-3 rounded-lg border border-accent-teal/30 bg-accent-teal/15 px-3 py-2 text-xs text-accent-teal"
        >
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-hairline hover:border-success/25 ',
            ]"
          >
            <div
              :class="[
      ...
      <div v-if="form.platform === 'gemini'">
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            class="flex items-center gap-1 rounded px-2 py-1 text-xs text-primary-700 hover:bg-accent-teal/10"
          >
            <svg
              class="h-4 w-4"
              fill="none"
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-hairline hover:border-accent-teal/40 ',
            ]"
          >
            <div
              :class="[
        ...
        <div
          ...
          class="mt-3 rounded-lg border border-primary-200 bg-primary-50 px-3 py-2 text-xs text-primary-800"
        >
          ...
          <div class="mt-2 grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <span class="text-xs text-muted"> 企业级，需要 GCP 项目 </span>
                <div class="mt-1 text-xs text-muted">
                  需要激活 GCP 项目并绑定信用卡
                  <a
                    :href="geminiHelpLinks.gcpProject"
                    class="ml-1 text-primary-700 hover:underline"
                    target="_blank"
                    rel="noreferrer"
                  >
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  <span
                    class="rounded bg-accent-teal/15 px-2 py-0.5 text-[10px] font-semibold text-primary-700"
                  >
                    企业用户
                  </span>
                  <span
          ...
          <div v-if="showAdvancedOAuth" class="mt-3 group relative">
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  <span
                    class="rounded bg-accent-amber/15 px-2 py-0.5 text-[10px] font-semibold text-warning"
                  >
              ...
              <span
                ...
                class="ml-auto shrink-0 rounded bg-accent-amber/15 px-2 py-0.5 text-xs text-warning"
              >
                {{
            ...
            <div
              v-if="!geminiAIStudioOAuthEnabled"
              class="pointer-events-none absolute right-0 top-full z-50 mt-2 w-80 rounded-md border border-accent-amber/30 bg-accent-amber/15 px-3 py-2 text-xs text-warning opacity-0 shadow-card transition-opacity group-hover:opacity-100"
            >
        ...
        <div>
          ...
          <div
            :class="[
              ...
              vertexServiceAccountDragActive
                ? 'border-accent-teal bg-accent-teal/15 '
                : 'border-hairline bg-surface-soft hover:border-accent-teal hover:bg-accent-teal/15 ',
            ]"
          ...
          >
            ...
            <div
              ...
              class="mt-3 rounded-md border border-accent-teal/30 bg-canvas px-3 py-2 text-xs text-accent-teal"
            >
              <div class="truncate">
      ...
      <div
        v-if="form.type === 'apikey' && form.platform !== 'antigravity'"
        class="space-y-4"
      >
        <div>
        ...
        <div class="border-t border-hairline pt-4">
          ...
          <div
            ...
            class="mb-3 rounded-lg bg-accent-amber/15 p-3"
          >
        ...
        <div class="border-t border-hairline pt-4">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                ...
                poolModeEnabled ? 'bg-primary-600' : 'bg-hairline ',
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="poolModeEnabled" class="rounded-lg bg-accent-teal/10 p-3">
            <p class="text-xs text-primary-700">
              <Icon
        ...
        <div class="border-t border-hairline pt-4">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                customErrorCodesEnabled ? 'bg-primary-600' : 'bg-hairline ',
              ]"
            >
              <span
                :class="[
      ...
      <div
        ...
        "
        class="border-t border-hairline pt-4 space-y-4"
      >
        <div class="mb-3">
      ...
      <div class="border-t border-hairline pt-4 space-y-4">
        <div class="mb-3 flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              tempUnschedEnabled ? 'bg-primary-600' : 'bg-hairline ',
            ]"
          >
            <span
              :class="[
        ...
        <div v-if="tempUnschedEnabled" class="space-y-3">
          <div class="rounded-lg bg-accent-teal/10 p-3">
            <p class="text-xs text-primary-700">
              <Icon
                name="exclamationTriangle"
                size="sm"
          ...
          <div class="flex flex-wrap gap-2">
            <button
              ...
              class="rounded-lg bg-surface-card px-3 py-1.5 text-xs font-medium text-body transition-colors hover:bg-hairline"
            >
              + {{ preset.label }}
            </button>
          </div>
          ...
          <button
            ...
            class="w-full rounded-lg border-2 border-dashed border-hairline px-4 py-2 text-sm text-body transition-colors hover:border-muted-soft hover:text-body"
          >
            <svg
              class="mr-1 inline h-4 w-4"
              fill="none"
        ...
        <div class="rounded-lg border border-hairline p-4">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                windowCostEnabled ? 'bg-primary-600' : 'bg-hairline ',
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-hairline p-4">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                sessionLimitEnabled ? 'bg-primary-600' : 'bg-hairline ',
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-hairline p-4">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                tlsFingerprintEnabled ? 'bg-primary-600' : 'bg-hairline ',
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-hairline p-4">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                sessionIdMaskingEnabled ? 'bg-primary-600' : 'bg-hairline ',
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-hairline p-4">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                cacheTTLOverrideEnabled ? 'bg-primary-600' : 'bg-hairline ',
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-hairline p-4">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                customBaseUrlEnabled ? 'bg-primary-600' : 'bg-hairline ',
              ]"
            >
              <span
                :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              anthropicPassthroughEnabled ? 'bg-primary-600' : 'bg-hairline ',
            ]"
          >
            <span
              :class="[
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              autoPauseOnExpired ? 'bg-primary-600' : 'bg-hairline ',
            ]"
          >
            <span
              :class="[
      ...
      <div class="border-t border-hairline pt-4">
        ...
        >
          ...
          <div class="group relative">
            <span
              class="inline-flex h-4 w-4 cursor-help items-center justify-center rounded-full bg-hairline text-xs text-muted hover:bg-surface-cream-strong"
            >
              ?
            </span>
            <!-- Tooltip（向下显示避免被弹窗裁剪） -->
            <div
              class="pointer-events-none absolute left-0 top-full z-[100] mt-1.5 w-72 rounded bg-surface-dark px-3 py-2 text-xs text-on-primary opacity-0 transition-opacity group-hover:opacity-100"
            >
...
const parseVertexServiceAccountJson = () =>
  applyVertexServiceAccountJson(vertexServiceAccountJson.value);
...
const handleSubmit = async () => {
  ...
  if (
    ...
    await createAccountAndFinish(
      form.platform,
      "service_account" as AccountType,
      credentials,
    );
    return;
  }
...
const buildOpenAICodexImportCredentialExtras = (): Record<
  string,
  unknown
> | null => {
  const credentials: Record<string, unknown> = {};
...
const handleOpenAIImportCodexSession = async (content: string) => {
  ...
  try {
    ...
    const result = await adminAPI.accounts.importCodexSession({
      ...
      auto_pause_on_expired: autoPauseOnExpired.value,
      credential_extras:
        Object.keys(credentialExtras).length > 0 ? credentialExtras : undefined,
      extra,
    ...
    oauthClient.error.value = [errorText, warningText]
      .filter(Boolean)
      .join("\n");
    ...
    for (let i = 0; i < refreshTokens.length; i++) {
      try {
        ...
        if (!tokenInfo) {
          failedCount++;
          errors.push(
            `#${i + 1}: ${oauthClient.error.value || "Validation failed"}`,
          );
          oauthClient.error.value = "";
          continue;
        }
        ...
        const accountName =
          refreshTokens.length > 1 ? `${baseName} #${i + 1}` : baseName;

<template>
  <div class="rounded-lg border border-accent-teal/30 bg-accent-teal/10 p-4">
    <div class="flex items-start gap-4">
      <div
        class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-accent-teal"
      >
        <Icon name="link" size="md" class="text-on-primary" />
      </div>
      <div class="flex-1">
        ...
        <div v-if="showMethodSelection" class="mb-4">
          <label class="mb-2 block text-sm font-medium text-body-strong">
            {{ methodLabel }}
          </label>
        ...
        <div
          ...
          class="space-y-4"
        >
          <div class="rounded-lg border border-accent-teal/40 bg-canvas/80 p-4">
            ...
            <div class="mb-4">
              <label
                class="mb-2 flex items-center gap-2 text-sm font-semibold text-body"
              >
                <Icon name="key" size="sm" class="text-accent-teal" />
                Refresh Token
                <span
                  v-if="parsedRefreshTokenCount > 1"
                  class="rounded-full bg-accent-teal px-2 py-0.5 text-xs text-on-primary"
                >
                  {{
              ...
              <p
                v-if="parsedRefreshTokenCount > 1"
                class="mt-1 text-xs text-primary-700"
              >
                {{
            ...
            <div
              v-if="error"
              class="mb-4 rounded-lg border border-error/25 bg-error/15 p-3"
            >
              <p class="whitespace-pre-line text-sm text-error">
                {{ error }}
              </p>
            </div>
          ...
          <div class="rounded-lg border border-accent-teal/40 bg-canvas/80 p-4">
            ...
            <div class="mb-4">
              ...
              <textarea
                ...
                class="input w-full resize-y font-mono text-sm"
                :placeholder="
                  t('admin.accounts.oauth.openai.codexSessionPlaceholder')
                "
                spellcheck="false"
              ></textarea>
        ...
        <div v-if="inputMethod === 'cookie'" class="space-y-4">
          <div class="rounded-lg border border-accent-teal/40 bg-canvas/80 p-4">
            ...
            <div class="mb-4">
              ...
              >
                ...
                <button
                  v-if="showHelp"
                  type="button"
                  class="text-accent-teal hover:text-primary-700"
            ...
            <div
              ...
              class="mb-4 rounded-lg border border-accent-amber/30 bg-accent-amber/15 p-3"
            >
        ...
        <div v-if="inputMethod === 'manual'" class="space-y-4">
          <p class="mb-4 text-sm text-body-strong">
            {{ oauthFollowSteps }}
          </p>
          ...
          <div class="rounded-lg border border-accent-teal/40 bg-canvas/80 p-4">
            <div class="flex items-start gap-3">
              <div
                class="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-primary-500 text-xs font-bold text-on-primary"
              >
                1
              </div>
              <div class="flex-1">
                ...
                <div v-if="showProjectId && platform === 'gemini'" class="mb-3">
                  <label class="input-label flex items-center gap-2">
                    ...
                    <a
                      ...
                      class="inline-flex items-center gap-1 text-xs font-normal text-accent-teal hover:text-primary-700"
                    >
                      <svg
                        class="h-3 w-3"
                        fill="none"
                ...
                <div v-else class="space-y-3">
                  <div class="flex items-center gap-2">
                    <input
                      ...
                      readonly
                      type="text"
                      class="input flex-1 bg-surface-soft font-mono text-xs"
                    />
                    <button
                      type="button"
          ...
          <div class="rounded-lg border border-accent-teal/40 bg-canvas/80 p-4">
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                ...
                <div
                  v-if="isOpenAI"
                  class="mt-2 rounded border border-accent-amber/30 bg-accent-amber/15 p-3"
                >
                  <p
          ...
          <div class="rounded-lg border border-accent-teal/40 bg-canvas/80 p-4">
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                ...
                <div>
                  <label class="input-label">
                    <Icon
                      name="key"
                      size="sm"
                      class="mr-1 inline text-accent-teal"
                    />
                    {{ oauthAuthCode }}
                  </label>
                  <textarea
                  ...
                  <div
                    ...
                    class="mt-3 rounded-lg border-2 border-accent-amber bg-accent-amber/15 p-3"
                  >
                ...
                <div
                  v-if="error"
                  class="mt-3 rounded-lg border border-error/25 bg-error/15 p-3"
                >
                  <p class="whitespace-pre-line text-sm text-error">
                    {{ error }}
                  </p>

<template>
  ...
  >
    ...
    >
      ...
      <div
        class="sidebar-logo flex h-9 w-9 items-center justify-center overflow-hidden rounded-lg border border-hairline bg-canvas shadow-sm"
      >
        <img
          v-if="settingsLoaded"
      ...
      >
        <span
          class="sidebar-brand-title font-display text-xl font-medium leading-none text-ink"
        >
          {{ siteName }}
        </span>
        <!-- Version Badge -->
          ...
          <template v-for="item in adminNavItems" :key="item.path">
            ...
            <template v-if="item.children?.length">
              ...
              <div
                ...
                class="mb-1 ml-4 border-l border-hairline pl-2"
              >
                <router-link

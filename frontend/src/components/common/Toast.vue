    ...
    >
      ...
      >
        ...
        >
          <div class="p-4">
            <div class="flex items-start gap-3">
              ...
              <div class="min-w-0 flex-1">
                <p v-if="toast.title" class="text-sm font-semibold text-ink">
                  {{ toast.title }}
                </p>
                <p
                  :class="[
                    'text-sm leading-relaxed',
                    toast.title ? 'mt-1 text-body ' : 'text-ink ',
                  ]"
                >
                  {{ toast.message }}
                </p>
              ...
              <button
                ...
                class="-m-1 flex-shrink-0 rounded p-1 text-muted-soft transition-colors hover:bg-surface-card hover:text-body"
          ...
          <!-- Progress bar -->
          <div v-if="toast.duration" class="h-1 bg-surface-card">
            <div
              :class="[

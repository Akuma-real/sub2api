  ...
  <Teleport to="body">
    <Transition name="popup-fade">
      <div
        ...
        class="fixed inset-0 z-[120] flex items-start justify-center overflow-y-auto bg-ink/45 p-4 pt-[8vh]"
      >
        <div
          class="w-full max-w-[680px] overflow-hidden rounded-lg bg-canvas shadow-card ring-1 ring-ink/5"
          @click.stop
        >
          <div
          ...
          >
            <div class="relative z-10">
              ...
              <!-- Title -->
              <h2 class="mb-2 text-2xl font-bold leading-tight text-ink">
              ...
              <div class="flex items-center gap-1.5 text-sm text-body">
                ...
                <time>{{
                  formatRelativeWithDateTime(
                    announcementStore.currentPopup.created_at,
                  )
                }}</time>
              </div>
            </div>
          ...
          <!-- Body -->
          <div class="max-h-[50vh] overflow-y-auto bg-canvas px-8 py-8">
            <div class="relative">
              <div
          ...
          >
            <div class="flex items-center justify-end">
              <button
                @click="handleDismiss"
                class="rounded-lg bg-primary-500 px-6 py-2.5 text-sm font-medium text-on-primary transition-colors hover:bg-primary-600"
              >

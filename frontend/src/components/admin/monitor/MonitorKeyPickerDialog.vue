  ...
  >
    <div class="space-y-3">
      ...
      <div class="relative">
        ...
        />
        <svg
          class="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-soft"
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          stroke-width="2"
      ...
      >
        <table class="w-full text-sm">
          <thead class="bg-surface-soft sticky top-0 z-10">
            <tr
              class="text-left text-xs font-medium uppercase tracking-wider text-muted"
            >
          ...
          <tbody class="divide-y divide-hairline">
            <tr
              ...
              @click="$emit('pick', k)"
            >
              <td class="px-3 py-2 font-medium text-ink">{{ k.name }}</td>

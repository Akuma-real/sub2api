<template>
  ...
  >
    ...
    >
      ...
      <div>
        ...
        <div class="relative flex gap-2">
          <div class="relative flex-1">
            <div
              class="absolute left-3 top-1/2 -translate-y-1/2 font-medium text-muted"
            >
              $
            </div>
            <input
      ...
      <div
        v-if="form.amount > 0"
        class="rounded-xl border border-accent-teal/30 bg-accent-teal/10 p-4"
      >
        <div class="flex items-center justify-between text-sm">
          <span class="text-body">{{ t("admin.users.newBalance") }}:</span

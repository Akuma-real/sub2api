<template>
  ...
  >
    <div v-if="user" class="space-y-6">
      <!-- 用户信息头部 -->
      <div
        class="flex items-center gap-4 rounded-lg bg-primary-100 p-5"
      >
        <div
          class="flex h-14 w-14 items-center justify-center rounded-full bg-canvas shadow-sm"
        >
        ...
        <div class="flex-1">
          <p class="text-lg font-semibold text-ink">{{ user.email }}</p>
      ...
      <div v-else class="space-y-6">
        ...
        <div v-if="exclusiveGroups.length > 0">
          <div class="mb-3 flex items-center gap-2">
            ...
            <span class="text-xs text-muted-soft"
              ...
              }}/{{ exclusiveGroupConfigs.length }})</span
            >
          </div>
              ...
              <div class="flex items-center gap-4">
                ...
                <div class="flex-shrink-0">
                  ...
                  >
                    ...
                    />
                    <div
                      class="h-5 w-5 rounded-md border-2 border-hairline transition-all peer-checked:border-primary-500 peer-checked:bg-primary-500 peer-checked:"
                    >
                      <svg
                        v-if="config.isSelected"
                        class="h-full w-full text-on-primary"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        stroke-width="3"
                ...
                <div class="flex flex-shrink-0 items-center gap-3">
                  ...
                  <input
                    ...
                    class="hide-spinner w-24 rounded-lg border border-hairline bg-canvas px-3 py-2 text-sm font-medium transition-colors focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
                  />
                </div>
              </div>
            </div>
        ...
        <div v-if="publicGroups.length > 0">
          <div class="mb-3 flex items-center gap-2">
            ...
            <span class="text-xs text-muted-soft"
              >({{ publicGroupConfigs.length }})</span
            >
          </div>
          <div class="grid gap-3">
            <div
              ...
              :key="config.groupId"
              class="relative overflow-hidden rounded-xl border-2 border-success/25 bg-success/15 p-4"
            >
              <div class="flex items-center gap-4">
                <!-- 复选框（禁用状态） -->
                <div class="flex-shrink-0">
                  <div
                    class="flex h-5 w-5 items-center justify-center rounded-md border-2 border-success bg-success"
                  >
                    <svg
                      class="h-full w-full text-on-primary"
                      fill="none"
        ...
        >
          <div
            class="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-surface-card"
          >
            <svg
          ...
          <p class="text-muted">{{ t("common.noGroupsAvailable") }}</p>
        </div>
      </div>
    </div>
...
const exclusiveGroups = computed(() =>
  groups.value.filter((g) => g.is_exclusive),
);
...
const exclusiveGroupConfigs = computed(() =>
  groupConfigs.value.filter((c) => c.isExclusive),
);

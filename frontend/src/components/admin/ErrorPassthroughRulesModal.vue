  ...
  >
    <div class="space-y-4">
      ...
      <div v-if="loading" class="flex items-center justify-center py-8">
        <Icon name="refresh" size="lg" class="animate-spin text-muted-soft" />
      </div>
      ...
      <div v-else-if="rules.length === 0" class="py-8 text-center">
        ...
        >
          <Icon name="shield" size="lg" class="text-muted-soft" />
        </div>
        <h4 class="mb-1 text-sm font-medium text-ink">
      ...
      <div
        v-else
        class="max-h-96 overflow-auto rounded-lg border border-hairline"
      >
        <table class="min-w-full divide-y divide-hairline">
          <thead class="sticky top-0 bg-surface-soft">
            <tr>
              <th
          ...
          <tbody class="divide-y divide-hairline bg-canvas">
            ...
            >
              <td class="whitespace-nowrap px-3 py-2">
                <span
                  class="inline-flex h-5 w-5 items-center justify-center rounded bg-surface-card text-xs font-medium text-body"
                >
                  {{ rule.priority }}
                </span>
              </td>
              <td class="px-3 py-2">
                <div class="font-medium text-ink text-sm">{{ rule.name }}</div>
                <div
                  v-if="rule.description"
                  class="mt-0.5 text-xs text-muted max-w-xs truncate"
                >
                  {{ rule.description }}
                </div>
              </td>
              ...
              <td class="px-3 py-2">
                <button
                  ...
                  :class="[
                    ...
                    rule.enabled ? 'bg-primary-600' : 'bg-hairline ',
                  ]"
                >
                  <span
                    :class="[
                      'pointer-events-none inline-block h-3 w-3 transform rounded-full bg-canvas shadow ring-0 transition duration-200 ease-in-out',
              ...
              <td class="px-3 py-2">
                <div class="flex items-center gap-1">
                  <button
                    ...
                    class="p-1 text-muted hover:text-primary-600"
                    :title="t('common.edit')"
                  >
                  ...
                  <button
                    ...
                    class="p-1 text-muted hover:text-error"
    ...
    >
      <form @submit.prevent="handleSubmit" class="space-y-4">
        ...
        <div class="rounded-lg border border-hairline p-3">
          <h4 class="mb-2 text-sm font-medium text-ink">
            ...
            <div class="mt-1 space-y-2">
              ...
              >
                <input
                  ...
                  class="mt-0.5 h-3.5 w-3.5 border-hairline text-primary-600 focus:ring-primary-500"
                />
                <div class="flex-1">
          ...
          <div class="mt-3">
            ...
            <div class="flex flex-wrap gap-3">
              ...
              >
                ...
                />
                <span class="text-xs text-body">{{ platform.label }}</span>
              </label>
            </div>
        ...
        <div class="flex items-center gap-1.5">
          <input
            ...
            class="h-3.5 w-3.5 rounded border-hairline text-warning focus:ring-accent-amber"
          />
          <span class="text-xs font-medium text-body">

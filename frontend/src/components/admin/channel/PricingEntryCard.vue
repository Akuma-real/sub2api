<template>
  <div class="rounded-lg border border-hairline bg-surface-soft p-3">
    ...
    >
      <Icon
        ...
        size="sm"
        :stroke-width="2"
        class="flex-shrink-0 text-muted-soft transition-transform duration-200"
      />
      ...
      >
        ...
        <div class="flex min-w-0 flex-1 flex-wrap items-center gap-1">
          ...
          <span
            ...
            class="whitespace-nowrap text-xs text-muted-soft"
          >
      ...
      <div v-else class="flex-1 text-xs font-medium text-muted">
      ...
      <button
        ...
        class="flex-shrink-0 rounded p-1 text-muted-soft hover:text-error"
      >
      ...
      <div class="collapsible-inner">
        ...
        <div v-if="entry.billing_mode === 'token'">
          ...
          <label class="mt-3 block text-xs font-medium text-muted">
            ...
            <span class="ml-1 font-normal text-muted-soft">$/MTok</span>
          </label>
          <div class="mt-1 grid grid-cols-2 gap-2 sm:grid-cols-5">
            <div>
              <label class="text-xs text-muted-soft">{{
            ...
            <div>
              <label class="text-xs text-muted-soft">{{
                t("admin.channels.form.cacheWritePrice", "缓存写入")
              }}</label>
              <input
            ...
            <div>
              <label class="text-xs text-muted-soft">{{
                t("admin.channels.form.cacheReadPrice", "缓存读取")
              }}</label>
              <input
            ...
            <div>
              <label class="text-xs text-muted-soft">{{
                t("admin.channels.form.imageTokenPrice", "图片输出")
              }}</label>
              <input
          ...
          <div class="mt-3">
            <div class="flex items-center justify-between">
              <label class="text-xs font-medium text-muted">
                ...
                <span class="ml-1 font-normal text-muted-soft">(min, max]</span>
              </label>
              <button
                type="button"
                @click="addInterval"
        ...
        <div v-else-if="entry.billing_mode === 'per_request'">
          ...
          <label class="mt-3 block text-xs font-medium text-muted">
            ...
            <span class="ml-1 font-normal text-muted-soft">$</span>
          </label>
          <div class="mt-1 w-48">
            <input
          ...
          <div
            v-else
            class="mt-2 rounded border border-dashed border-hairline p-3 text-center text-xs text-muted-soft"
          >
            {{
              t(
...
const billingModeOptions = computed(() => [
  ...
  {
    value: "per_request",
    label: t("admin.channels.billingMode.perRequest", "按次"),
  },
  {
    value: "image",
    label: t("admin.channels.billingMode.image", "图片（按次）"),
  },
]);

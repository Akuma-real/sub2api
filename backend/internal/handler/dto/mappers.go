...
func APIKeyFromService(k *service.APIKey) *APIKey {
	...
	acceleration := k.AccelerationSettings.Normalize()
	out := &APIKey{
		ID:          k.ID,
		UserID:      k.UserID,
		Key:         k.Key,
		...
		AccelerationSettings: APIKeyAccelerationSettings{
			FastMode:                   acceleration.FastMode,
			DualProtectionEnabled:      acceleration.DualProtectionEnabled,
			DualFirstResponseTimeoutMS: acceleration.DualFirstResponseTimeoutMS,
		},
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		VIPDiscountMultiplier: l.VIPDiscountMultiplier,
		VIPPreDiscountCost:    l.VIPPreDiscountCost,
		VIPSavingsUSD:         l.VIPSavingsUSD,
		DualProtectionEnabled: l.DualProtectionEnabled,
		DualAttemptCount:      l.DualAttemptCount,
		DualExtraCost:         l.DualExtraCost,

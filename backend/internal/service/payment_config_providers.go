...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeMuyin:     {"token": {}, "apibase": {}, "platform": {}},
...
var validProviderKeys = map[string]bool{
	payment.TypeEasyPay: true, payment.TypeMuyin: true, payment.TypeAlipay: true, payment.TypeWxpay: true, payment.TypeStripe: true, payment.TypeAirwallex: true,
}
